...
public class EXITprompt extends JDialog {
	...
	public static void confirm() {
		try {
			EXITprompt dialog = new EXITprompt();
	 ...
	 */
	public EXITprompt() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(EXITprompt.class.getResource("/source/LOGO.png")));
		setTitle("CONFIRM");
		...
		contentPanel.setLayout(null);
		{
			...
			}
			{
				...
				lblNewLabel.setIcon(new ImageIcon(EXITprompt.class.getResource("/source/Cover2.png")));
